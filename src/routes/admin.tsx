  ...
  return (
    <div className="card-elevated grid gap-4 p-5 sm:grid-cols-[auto_1fr_auto] sm:items-center">
      ...
      <div className="min-w-0 space-y-1 text-sm">
        <div className="flex items-center gap-2 text-muted-foreground"><Mail className="h-3.5 w-3.5" /><span className="truncate">{a.email}</span></div>
      ...
      <div className="flex flex-col items-end gap-2">
        ...
        <div className="flex flex-wrap gap-1">
          {a.status !== "confirmed" && a.status !== "completed" && (
            <Button size="sm" variant="outline" onClick={() => onStatus(a.id, "confirmed")}>Confirm</Button>
          )}
          {a.status !== "completed" && (
